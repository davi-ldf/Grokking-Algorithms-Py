def buscaMenor(arr):
    ...
    menor_indice = 0
    # Percorre os índices de 1 até o final da lista
...
def ordenacaoPorSelecao(arr):
    # Cria uma lista nova para armazenar os elementos ordenados
    novoArr = []
    # Laço que roda N vezes, onde N é o tamanho inicial de 'arr'
    for i in range(len(arr)):
        # Encontra o índice do menor elemento da lista restante
        menor = buscaMenor(arr)
        # Remove o menor de 'arr' e adiciona ao final de 'novoArr'
        novoArr.append(arr.pop(menor))
    # Retorna a lista totalmente ordenada
    return novoArr
